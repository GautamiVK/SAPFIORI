jQuery.sap.declare("com.opensap.kapsel.Component");
jQuery.sap.require("com.opensap.kapsel.dev.devapp");
jQuery.sap.require("com.opensap.kapsel.MyRouter");

sap.ui.core.UIComponent.extend("com.opensap.kapsel.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "com.opensap.kapsel.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "northwind.svc",
				serviceUrl: "/northwind/V2/northwind/northwind.svc/" //does not work on phone , works on desktop 
				//serviceUrl: "http://services.odata.org/V2/(S(11adut1ba5ftryxkhykvnuni))/OData/OData.svc/" //does not work on desktop & phone
				//serviceUrl: "http://services.odata.org/V2/OData/OData.svc" //does not work on desktop & phone
			}
		},

		routing: {
			config: {
				routerClass: com.opensap.kapsel.MyRouter,
				viewType: "XML",
				viewPath: "com.opensap.kapsel.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.opensap.kapsel");
		...
		var oModel;
		var externalURL = com.opensap.kapsel.dev.devapp.externalURL;
		var appContext;
		if (com.opensap.kapsel.dev.devapp.devLogon) {
			appContext = com.opensap.kapsel.dev.devapp.devLogon.appContext;
		}
