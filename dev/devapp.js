jQuery.sap.declare("com.opensap.kapsel.dev.devapp");
jQuery.sap.require("com.opensap.kapsel.dev.devlogon");

com.opensap.kapsel.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = com.opensap.kapsel.dev.devapp;
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new com.opensap.kapsel.dev.devlogon();
