jQuery.sap.require("com.opensap.kapsel.util.Formatter");
jQuery.sap.require("com.opensap.kapsel.util.Controller");

com.opensap.kapsel.util.Controller.extend("com.opensap.kapsel.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.opensap.kapsel.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.opensap.kapsel.view.NotFound",
			targetViewType: "XML"
		});
	},
